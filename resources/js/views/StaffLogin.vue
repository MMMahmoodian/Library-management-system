    ...
    <div class="row col-lg-auto col-lg-auto login-row p-0">
      <div class="col-lg-6 p-0">
        <div>
          ...
          <h4 class="login-title">ورود کارکنان</h4>
        </div>
        <div class="row p-3">
...
export default {
  ...
  methods: {
    ...
    async login() {
      ...
      Staff.append("userName", this.userName);
      Staff.append("password", this.password);
      try {
        await this.LogInStaff(Staff);
        this.$router.push("/");
      } catch (error) {
        alert("Error");
      }
