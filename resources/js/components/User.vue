<template>
  <div class="user">
    ...
    نام:<td>{{ user.first_name }}</td>
    نام خانوادگی<td>{{ user.last_name }}</td>
    شماره تماس<td>{{ user.phone }}</td>
    پست الکترونیک<td>{{ user.email }}</td>
    شماره پستی<td>{{ user.postal_code }}</td>
    شماره ملی<td>{{ user.national_code }}</td>
